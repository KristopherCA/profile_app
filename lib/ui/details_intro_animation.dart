...
class DetailsIntroAnimation {
  DetailsIntroAnimation(this.controller)
      : bgdropOpacity = Tween(begin: 0.5, end: 1.0).animate(CurvedAnimation(
        ...
        dividerWidth = Tween(begin: 0.0, end: 225.0).animate(CurvedAnimation(
            parent: controller,
            curve: Interval(0.650, 0.75, curve: Curves.fastOutSlowIn))),
        aboutOpacity = Tween(begin: 0.0, end: 0.86).animate(CurvedAnimation(
            parent: controller,
        ...
        projectScrollerOpacity = Tween(begin: 0.0, end: 1.0).animate(
            CurvedAnimation(
                parent: controller,
